...
const listaCarrito = document.getElementbyId("botonAgregarCarrito");
console.log(listaCarrito);
listaCarrito.addEventListener("click", agregarProductoCarrito)
